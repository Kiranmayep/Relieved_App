...
public class BallGameActivity extends AppCompatActivity {
    ...
    private BallSoundPlayer soundPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundPlayer = new BallSoundPlayer(this);
        ...
        imageBoxLeft = getResources().getDrawable(R.drawable.ballbox_left);
        imageBoxRight = getResources().getDrawable(R.drawable.ballbox_right);
